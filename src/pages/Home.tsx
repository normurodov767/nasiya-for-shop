...
import { CalendarOutlined, EyeOutlined, EyeInvisibleOutlined, WalletOutlined, PlusOutlined,} from "@ant-design/icons";
                ...
                <div className="Home__cards">
                    <div className="prices">
                        <div className="prices-item">
                            <h3>{isVisible ? `${user?.data?.wallet || "135 214 200"} so'm` : "******"}</h3>
                            <p>Umumiy nasiya:</p>
                        </div>
                    ...
                    <div className="Home__wallet-info">
                        <div className="wallet">
                            ...
                            <div className="wallet-amount">
                                <p>Hisobingizda</p>
                                <h3>{user?.data?.wallet || "300 000"} so'm</h3>
                            </div>
                        </div>
